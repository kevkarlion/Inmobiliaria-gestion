...
export default function Navbar() {
  ...
  return (
    // Agregamos la clase navbar-container para el parche CSS
    <header className="font-montserrat navbar-container w-full fixed top-0 left-0 z-50 shadow-sm bg-transparent">
      
      {/* --- TOP BAR (Desktop Only) --- */}
      {/* El fondo blanco aquí se une con el parche blanco en desktop */}
      ...
      {/* En móvil, este azul se une con el parche Oxford del CSS */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                className="lg:hidden p-2 text-gold-sand"
