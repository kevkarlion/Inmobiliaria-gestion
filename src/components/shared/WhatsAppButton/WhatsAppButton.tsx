...
const WhatsAppButton = () => {
  ...
  // Show label after 2s, auto-hide after 8s
  useEffect(() => {
    if (dismissed) return;
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex items-center gap-2.5">
      ...
      {!dismissed && (
        <div
          className={`flex items-center gap-2 bg-white text-slate-700 text-xs font-semibold 
                      px-3.5 py-2 rounded-full shadow-lg border border-slate-100
      ...
      <a
        ...
        className="relative flex items-center justify-center 
                   w-14 h-14 
                   bg-[#25D366] text-white rounded-full shadow-lg shadow-[#25D366]/30
                   hover:shadow-xl hover:shadow-[#25D366]/40 hover:scale-105 
