  ...
  return (
    <div ref={containerRef} className="relative w-full mx-auto font-montserrat">
      ...
      >
        ...
        <button className="hidden md:flex order-3 ml-2 p-3 bg-gold-sand text-slate-900 rounded-full shadow-md">
            ...
            {filtered.length > 0 ? (
              filtered.map((p) => (
                <Link
                  ...
                  className="flex items-center gap-4 p-3 hover:bg-slate-50 rounded-2xl"
                >
